...
GO
/****** Object:  Table [dbo].[Corretores]    Script Date: 03/08/2023 20:18:54 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Empreendimentos]    Script Date: 03/08/2023 20:18:54 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[GrupoUsuario]    Script Date: 03/08/2023 20:18:54 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Permissao]    Script Date: 03/08/2023 20:18:54 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PermissaoGrupoUsuario]    Script Date: 03/08/2023 20:18:54 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Reservas]    Script Date: 03/08/2023 20:18:54 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Terrenos]    Script Date: 03/08/2023 20:18:54 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Terrenos](
	[IDTerreno] [int] NOT NULL,
	[IDEmpreendimento] [int] NOT NULL,
	[PrecoAVista] [decimal](18, 2) NOT NULL,
	[PrecoParcelado] [decimal](18, 2) NOT NULL,
	[RedeAguaEnergia] [bit] NOT NULL,
	[MetragemFrente] [decimal](18, 2) NOT NULL,
	[MetragemFundo] [decimal](18, 2) NOT NULL,
	[MetragemLaterais] [decimal](18, 2) NOT NULL,
	[TamanhoTotalTerreno] [decimal](18, 2) NOT NULL,
...
GO
/****** Object:  Table [dbo].[Usuario]    Script Date: 03/08/2023 20:18:54 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[UsuarioGrupoUsuario]    Script Date: 03/08/2023 20:18:54 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Vendas]    Script Date: 03/08/2023 20:18:54 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
